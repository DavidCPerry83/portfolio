...
Search the codebase for "David" or "DavidCPerry83" to find any remaining references to change.

```bash
grep -r "David" src/
grep -r "DavidCPerry83" .
```
...
- Open an issue: https://github.com/DavidCPerry83/portfolio/issues
- Email: davidcperry1983@gmail.com
